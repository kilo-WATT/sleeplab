...
def finish_import_run(
    ...
    *,
    ...
    sessions_added: int | None = None,
    sessions_updated: int | None = None,
    sessions_skipped: int | None = None,
    waveform_chunks: int | None = None,
    ...
    with conn.cursor() as cur:
        ...
        cur.execute(
            ...
            SET status = %s,
                ...
                sessions_added_count = %s,
                sessions_updated_count = %s,
                sessions_skipped_count = %s,
                waveform_chunk_count = %s,
                warnings = %s::jsonb,
